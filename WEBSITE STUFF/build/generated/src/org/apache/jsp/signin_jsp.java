...
public final class signin_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(request.getAttribute("err") != null){ 
      ...
      out.write("                <input id=\"fix\" class = \"textbox\" type = \"text\" name=\"username\" placeholder=\"user\"> <br> <!-- \"username is just text, input type is an input (can be button/text/etc), name is variable name-->\n");
      out.write("                <input class = \"textbox\" type = \"password\" name=\"password\" placeholder=\"password\"><br>\n");
      out.write("                <input class = \"button\" type =\"submit\" value=\"Sign In\" >\n");
      out.write("                <button class = \"button\" onclick=\"window.location='createAccount.jsp'\">Create Account</button> <br><!-- button to go to create account page-->\n");
      out.write("                <br>\n");
