    ...
    <body>
        <div align="center" class = "formholder">  <!-- a div is just a grouping, class is just a group name for CSS styling-->
            <form class = "form" action ="signin" method = "post"> <!-- action is what page its going to next-->
                ...
                <label>Last Name:</label> <input class = "textbox" type = "password" name="Last name" placeholder="Doe"required maxlength="15"><br>
                ...
                <label>Password:</label> <input id="fix" class = "textbox" type = "text" name="Password" placeholder="password"required maxlength="15"> <br> 
                <label>Telephone:</label> <input id="fix" class = "textbox" type = "text" name="Telephone" placeholder="xxx-xxx-xxxx"required maxlength="12"> <br> 
                ...
                <label>Zip Code:</label> <input id="fix" class = "textbox" type = "text" name="Zipcode" placeholder="11111" required maxlength="15"> <br>
                <label>Credit card:</label> <input id="fix" class = "textbox" type = "text" name="Credit" placeholder="xxxxxxxxxxxxxxxx"  maxlength="16" required> <br> 
