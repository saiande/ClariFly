...
//        int rating=0;
        ...
        id++;
        CallableStatement cs = db.getCon().prepareCall("{call AddEmployee(?,?,?,?,?,?,?,?,?,?,?,?,?)}");
        cs.setInt(1, id);
        ...
        cs.setString(8, telephone);
        cs.setInt(9, Integer.parseInt(ssn));
        cs.setInt(10, Integer.parseInt(manager));
        cs.setTimestamp(11, new java.sql.Timestamp(today.getTime()));
        cs.setDouble(12, Double.parseDouble(hr));
