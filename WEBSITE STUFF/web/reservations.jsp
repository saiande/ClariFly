...
<html>
    ...
    <body>
        ...
        %>
        <h1>Go To:</h1>
        <h1>Reservations by Flight</h1>
            <form action="FlightReserveServe" method ="POST" >
                <h3>Flight No:</h3>
                <input style ="margin-left: 40%;  margin-top: 10px; font-size: 1.3em;" type="text" id="flightNo" name="flightNo" required >
            <input class = "button" type="submit" value="Submit" ></form>
        
        <h3>Reservations by Customer</h3>
            <form action="ReserveCustomerServe" method ="POST" >
                <h3>Customer ID:</h3>
                     <input style ="margin-left: 40%; margin-top: 10px; font-size: 1.3em;"type="text" id="customerID" name="customerID" required>
            <input class = "button"type="submit" value="Submit" ></form>
